...
urlpatterns = [
    ...
    path('api/ds-160/', include('ds_160.urls')),
    path('api/ds-260/', include('ds_260.urls')),
    path('api/eb-1aA/', include('eb_1aA.urls')),
    path('api/eb-1aB/', include('eb_1aB.urls')),
    path('api/final-copy/', include('final_copy.urls')),
    path('api/naturalization/', include('naturalization.urls')),
    path('api/reentry-permit/', include('reentry_permit.urls')),
]
