...
class RAGConfig:
    ...
    search_type: str = "mmr"
    pipeline_version: str = "naturalization-rag-v1"
...
def get_default_config() -> RAGConfig:
    cache_root = os.path.join(settings.MEDIA_ROOT, "naturalization_rag")
...
async def get_or_build_corpus(
    ...
    logger.info("Preparing naturalization corpus %s", corpus_hash)
